...
public class FlowEconomicsTask implements EconomicsTask {
    ...
    public void execute(CaseFile caseFile) {
        ...
        int vespene    = caseFile.get(QuarkMindCaseFile.VESPENE,     Integer.class).orElse(0);
        String strategy = caseFile.get(QuarkMindCaseFile.STRATEGY, String.class).orElse("MACRO");
        ResourceBudget shared = caseFile.get(QuarkMindCaseFile.RESOURCE_BUDGET, ResourceBudget.class)
