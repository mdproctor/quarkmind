...
/**
 * Basic tactics: act on the {@link StarCraftCaseFile#STRATEGY} key each tick.
 *
 * <ul>
 *   <li><b>ATTACK</b> — queue {@link AttackIntent} for each army unit toward
 *       {@link StarCraftCaseFile#NEAREST_THREAT} (from scouting), or toward
...
public class BasicTacticsTask implements TacticsTask {
    ...
    public void execute(CaseFile caseFile) {
        ...
        Point2d nearestThreat = caseFile.get(StarCraftCaseFile.NEAREST_THREAT, Point2d.class).orElse(null);
