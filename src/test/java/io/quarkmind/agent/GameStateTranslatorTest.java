...
class GameStateTranslatorTest {
    ...
    void translatesResourcesCorrectly() {
        var state = new GameState(150, 75, 23, 14, List.of(), List.of(), List.of(), List.of(), List.of(), List.of(), 42L);
    ...
    void separatesWorkersFromArmy() {
        ...
        var state = new GameState(50, 0, 15, 3, List.of(probe, zealot), List.of(), List.of(), List.of(), List.of(), List.of(), 0L);
        Map<String, Object> map = translator.toMap(state);
