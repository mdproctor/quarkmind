...
class GameStateTest {
    ...
    void initialProtossGameState() {
        var probe = new Unit("tag-1", UnitType.PROBE, new Point2d(10.0f, 10.0f), 45, 45, 20, 20, 0);
    ...
    void probeCount() {
        var probes = List.of(
            new Unit("t1", UnitType.PROBE, new Point2d(0, 0), 45, 45, 20, 20, 0),
            new Unit("t2", UnitType.PROBE, new Point2d(1, 1), 45, 45, 20, 20, 0),
            new Unit("t3", UnitType.ZEALOT, new Point2d(2, 2), 100, 100, 50, 50, 0)
        );
